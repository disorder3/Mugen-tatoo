...
const Faq = () => {
  const faqPanelRef = React.useRef(null);
  ...
  const toggleAnswer = (event) => {
    ...
    if (answer.classList.contains("active")) {
      ...
      const panels = faqPanelRef.current.getElementsByClassName("faq-panel");
  ...
  React.useEffect(() => {
    const questions = faqPanelRef.current.getElementsByClassName("faq-question");
  ...
  return (
    <div className="faq" ref={faqPanelRef}>
      <button className="faq-question">Est-ce douloureux ?</button>
      <div className="faq-panel">
        <p className="faq-answer">
          La douleur est subjective ! et varie en fonction des individus, l’acte
          en lui-même n’est pas une torture, on peut parler de sensation gênante
      ...
      <button className="faq-question">Quel motif pour mon tatouage ?</button>
      <div className="faq-panel">
        <p className="faq-answer">
          Il est important de choisir un motif original et personnel pour son
          tatouage, car il fera partie de votre corps et votre personnalité, les
