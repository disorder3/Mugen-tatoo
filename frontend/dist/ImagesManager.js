...
var ImagesManager = function ImagesManager() {
  var _React$useState = React.useState(JSON.parse(localStorage.getItem("user")) // obtenir les informations de l'utilisateur connecté
    ),
  ...
  var _React$useState5 = React.useState([]),
    ...
    selectedImages = _React$useState6[0],
    setSelectedImages = _React$useState6[1];
  ...
  var _React$useState9 = React.useState(false),
    ...
    adding = _React$useState10[0],
    setAdding = _React$useState10[1];
  var _React$useState11 = React.useState(false),
    _React$useState12 = _slicedToArray(_React$useState11, 2),
    loadingImages = _React$useState12[0],
    setLoadingImages = _React$useState12[1];
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return axios.get("".concat(SERVER_URL, "/images"));
            case 4:
  ...
  var handleChange = function handleChange(event) {
    ...
    var images = Array.from(files).filter(function (file) {
  ...
  var handleSubmit = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var body, i, _yield$axios$post, data;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 4;
            _context2.next = 7;
            return axios.post("".concat(SERVER_URL, "/admin/addImages"), body, {
              headers: {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return axios["delete"]("".concat(SERVER_URL, "/images/").concat(_id), {
              headers: {
                Authorization: "Bearer ".concat(localStorage.getItem("token"))
              }
            });
  ...
  }, loadingImages ? /*#__PURE__*/React.createElement("p", null, "Loading images...") : images.length ? images.map(function (img) {
    return /*#__PURE__*/React.createElement("div", {
      style: {
        position: "relative"
      }
...
ReactDOM.render( /*#__PURE__*/React.createElement(ImagesManager, null), document.getElementById("ImagesManager"));